  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:site" content="@haonguyen_tech" />
        <meta name="twitter:title" content="Hao Nguyen Personal Portfolio" />
        <meta
          name="twitter:description"
          content="Hi my name is Hao Nguyen.I'm a front-end developer based in Vietnam Welcome to my portfolio"
        />
        <meta name="robots" content="index, follow" />
        <title>Hao Portfolio - Full Stack Developer</title>
