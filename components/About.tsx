...
export const About = () => {
  return (
    <div className="mt-2 flex flex-col items-center justify-center">
      ...
      <div className="mx-auto grid grid-cols-1 place-content-center gap-6 md:relative md:z-0 md:max-w-[80%] md:grid-cols-3 md:flex-row md:rounded-lg md:border md:border-stone-900 md:shadow-2xl lg:grid-cols-3 xl:max-w-[70%]">
        ...
        >
          ...
          <Image
            className="h-48 w-48 rounded-full object-cover object-center backdrop-blur-md md:h-full md:w-full md:self-end md:rounded-md"
            alt="Hao"
            src={HaoAva}
            placeholder="blur"
          />
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 1.2 }}
          className="flex h-full flex-col items-center gap-6 px-2 md:col-span-2 md:items-start md:justify-center md:gap-4 md:py-4  xl:text-lg"
        >
          <p className="text-center font-serif text-sm font-light md:max-w-[90%] md:text-left md:leading-[25px] lg:text-lg xl:leading-[40px]">
