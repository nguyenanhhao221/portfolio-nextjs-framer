    ...
    return (
        <div className="flex h-screen flex-col items-center justify-center gap-1 overflow-hidden text-center">
            ...
            <motion.h1
                ...
                className="bg-gradient-to-l from-gradient-blue-apple-from via-gradient-blue-apple-via to-gradient-blue-apple-to bg-clip-text text-xl font-extrabold uppercase tracking-widest text-transparent md:text-3xl md:tracking-[13px]"
            >
                Hao Nguyen
                <br />
